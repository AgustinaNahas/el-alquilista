...
export default function CabaMap() {
    ...
    const [sueldo, setSueldo] = useState(350000);
        ...
        <div style={{ width: '100vw', height: '100vh' }}>
            ...
            >
                ...
                <Typography gutterBottom>
                    <MuiLink color="secondary"><Link target="_blank" href="https://www.boletinoficial.gob.ar/detalleAviso/primera/311320/20240726">Salario mínimo vital y movil</Link></MuiLink> (Última actualización: 6 agosto 2024)
                </Typography>
                <Typography gutterBottom>
                    <MuiLink color="secondary"><Link target="_blank" href="https://docs.google.com/spreadsheets/d/1DguVTyzAWadeUkkzokNIAQSDuQklfzFX7CwEfkkCnpc">Lista de alquileres completos de ZonaProp</Link></MuiLink> (Última actualización: 6 agosto 2024)
                </Typography>
                <Typography gutterBottom>
